...
/*Esto nos devuelve el promedio REDONDEADO de todos los valores de la columna price*
ROUND REDONDEA POR CANTIDAD DE DECIMALES O LIBRE, SI NO LE PONEMOS EL PARAMETRO DE
LA CANTIDAD DE DECIMALES POR DEFECTO DEJA SOLO LOS ENTEROS ROUND(N1,N2) N2 ES LA CANTIDAD DE DECIMALES
*/;

...
imgn = img_f + noise_sc
imgn.max()
# imgn = np.uint8(255*(imgn/imgn.max()))  # Para analizar... que pasa si escalo y convierto a uint8? Comparar
# histogramas de ambas ROIs

plt.figure()
ax1 = plt.subplot(121)
plt.imshow(img, cmap="gray"), plt.title("Imagen Original")
plt.subplot(122, sharex=ax1, sharey=ax1), plt.imshow(imgn, cmap="gray"), plt.title(
    "Imagen Ruidosa"
)
plt.show(block=False)
...
# imgn = imnoise_pepper(img, 0.1) imgn = imnoise_pepper(img, 0.2)
...
plt.figure()
ax1 = plt.subplot(221)
imshow(imgn, new_fig=False, colorbar=False, title="Imagen ruidosa")
plt.subplot(222, sharex=ax1, sharey=ax1), imshow(
    imgn_ch_filt, new_fig=False, colorbar=False, title="charmean"
)
plt.subplot(223, sharex=ax1, sharey=ax1), imshow(
    imgn_median_filt3, new_fig=False, colorbar=False, title="Median 3"
)
plt.subplot(224, sharex=ax1, sharey=ax1), imshow(
    imgn_median_filt5, new_fig=False, colorbar=False, title="Median 7"
)
plt.show(block=False)
...
# imgn = imnoise_salt(img, 0.1) imgn = imnoise_salt(img, 0.2)
...
plt.subplot(224, sharex=ax1, sharey=ax1), imshow(
    imgn_median_filt5, new_fig=False, colorbar=False, title="Median 5"
)
plt.show(block=False)
